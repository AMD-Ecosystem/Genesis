    ...
    def _build_static_config(self):
        ...
        if self.is_active:
            ...
            if gs.backend != gs.cpu:
                # Use the runtime query; works on both NVIDIA and AMDGPU (MI210/MI300x)
                # without hard-coding device-specific constants.
                ...
                max_n_warps = int(math.sqrt(max_shared_bytes / bytes_per_float)) // 32
