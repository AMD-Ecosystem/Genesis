...
class RigidOptions(Options):
    ...
    # constraint solver
    constraint_solver: gs.constraint_solver = gs.constraint_solver.GS  # OPT-PGS: projected Gauss-Seidel, 100% lane utilization
    iterations: PositiveInt = 12   # OPT-PGS: test 12 PGS iterations
